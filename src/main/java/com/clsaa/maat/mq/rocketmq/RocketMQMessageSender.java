package com.clsaa.maat.mq.rocketmq;
...
public class RocketMQMessageSender implements MessageSender {
    ...
    @Value("${maat.mq.RocketMQ.namesrvAddr}")
    private String namesrvAddr;
    @Value("${maat.mq.RocketMQ.groupName}")
    private String groupName;
    @Value("${maat.mq.RocketMQ.instanceName}")
    private String instanceName;
    @Value("${maat.mq.RocketMQ.maxMessageSize}")
    private Integer maxMessageSize;
    @Value("${maat.mq.RocketMQ.sendMessageTimeout}")
